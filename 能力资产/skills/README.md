...
| [借鉴.md](借鉴.md) | 外部参考源接入、评估、落地与审计的唯一操作入口 |
| ⭐ [项目体检.md](项目体检.md) | P4a-P4t framework 体检（字节阈值 / 计数对齐 / 交接区 / PM 轨迹 / 旧口径 / PM 工作区 / 活跃 Markdown 链接 / 能力资产剩余区 / 治理语义锚点 / hooks 配置 / 模板纯净度 / 借鉴闭环一致性等） |
